...
var WeatherApp = function WeatherApp() {
  ...
  var convert = function convert(i) {
    ...
    if (i !== unit && weatherData !== null) {
      if (unit == 'imperial') {
        setUnit('metric'); // const newWeather = weatherData
        // newWeather.main.temp = ((Math.floor(newWeather.main.temp) * 9) / 5) + 32
        // setWeather(newWeather)
      } else {
        setUnit('imperial'); // const newWeather = weather
...
//# sourceMappingURL=weather.js.1a15065eca330b2c3c04.hot-update.js.map