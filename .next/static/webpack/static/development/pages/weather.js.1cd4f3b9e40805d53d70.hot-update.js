  ...
  var convert = function convert(i) {
    if (i !== unit && weatherData !== null) {
      if (i === 'metric') {
        ...
        _newWeather.weather.data.main.temp = (Math.floor(_newWeather.weather.data.main.temp) - 32) * 5 / 9;
...
//# sourceMappingURL=weather.js.1cd4f3b9e40805d53d70.hot-update.js.map