  ...
  var convert = function convert(i) {
    ...
    if (i !== unit && weatherData !== null) {
      if (unit == 'imperial') {
        ...
        setUnit('imperial');
        var _newWeather = weatherData;
        _newWeather.main.temp = Math.floor(_newWeather.main.temp) * 9 / 5 + 32;
...
//# sourceMappingURL=weather.js.76e765e58d9b7b884ca7.hot-update.js.map